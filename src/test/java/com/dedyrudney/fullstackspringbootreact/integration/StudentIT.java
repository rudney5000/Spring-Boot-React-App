package com.dedyrudney.fullstackspringbootreact.integration;

import com.dedyrudney.fullstackspringbootreact.student.Gender;
import com.dedyrudney.fullstackspringbootreact.student.Student;
import com.dedyrudney.fullstackspringbootreact.student.StudentRepository;
...
public class StudentIT {
    ...
    void canRegisterNewStudent() throws Exception {
        ...
        Student student = new Student(
                name,
                String.format("%s@rudeneygmail.com",
    ...
    void canDeleteStudent() throws Exception {
        ...
        String email = String.format("%s@rudeney.com",
                StringUtils.trimAllWhitespace(name.trim().toLowerCase()));
